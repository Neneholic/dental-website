  ...
  return (
    <section id="services" className="py-24 md:py-32 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Services Grid - Sin label vertical que se encime */}
          ...
          >
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-16 h-16 bg-green-600 rounded-full flex items-center justify-center shadow-xl hover:scale-110 transition-transform"
              >
