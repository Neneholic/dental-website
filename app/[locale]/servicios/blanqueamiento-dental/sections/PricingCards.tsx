...
const features = [
  '1 sesión de blanqueamiento LED',
  'Hasta 4 tonos más claros',
  'Kit premium de cuidado post-tratamiento',
  'Consulta de seguimiento incluida',
  'Garantía de satisfacción 1 año',
  'Resultados inmediatos',
  'Tecnología de última generación',
  'Sin dolor ni sensibilidad',
];
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            Inversión en tu sonrisa
          </h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Un precio accesible para una transformación completa de tu sonrisa
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="mb-8">
            <div className="flex items-baseline justify-center gap-1">
              ...
              <span className="text-6xl md:text-7xl font-bold text-gray-900">1,750</span>
              <span className="text-xl text-gray-600">MXN</span>
            </div>
            <p className="text-gray-500 mt-2">Pago único - Sin cargos ocultos</p>
          </div>
          ...
          {/* CTA */}
          <a
            href="https://wa.me/5213310678412?text=Hola%2C%20me%20interesa%20el%20blanqueamiento%20dental%20por%20$1750%20MXN"
            target="_blank"
          ...
          <p className="text-sm text-gray-500 mt-4">
            Consulta de evaluación gratuita incluida
          </p>
        </motion.div>
      </div>
    </section>
