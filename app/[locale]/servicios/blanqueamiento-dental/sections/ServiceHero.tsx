...
export function ServiceHero() {
  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <Image
        src="/images/blanqueamiento-dental-guadalajara-hero.webp"
        alt={
          locale === 'es'
            ? 'Blanqueamiento dental profesional en Guadalajara con la Dra. Alondra Robles'
            : 'Professional teeth whitening in Guadalajara with Dr. Alondra Robles'
        }
        fill
        priority
        sizes="100vw"
