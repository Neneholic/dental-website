...
export function PricingCards() {
  const t = useTranslations('cleaning.pricing');
  const locale = useLocale();

  const whatsappText = locale === 'es'
    ? 'Hola, me interesa agendar una limpieza dental'
    : 'Hello, I am interested in scheduling a dental cleaning';
  ...
  return (
    <section id="precios" className="py-24 md:py-32 bg-[#B8D4E8]/20">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#B8D4E8] rounded-full text-sm font-medium mb-6">
          ...
          <a
            ...
            onClick={() => trackWhatsAppClick('pricing_cleaning')}
