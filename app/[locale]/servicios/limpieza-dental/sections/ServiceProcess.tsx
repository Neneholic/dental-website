...
import { Search, Zap, Sparkles, Shield } from 'lucide-react';
import { useTranslations } from 'next-intl';

const steps = [
  { number: '01', icon: Search, key: 'step1', iconBg: 'bg-[#B8D4E8]' },
  { number: '02', icon: Zap, key: 'step2', iconBg: 'bg-[#E8D5F2]' },
  { number: '03', icon: Sparkles, key: 'step3', iconBg: 'bg-[#B8D4E8]' },
  { number: '04', icon: Shield, key: 'step4', iconBg: 'bg-[#E8D5F2]' },
];
...
export function ServiceProcess() {
  ...
  return (
    <section id="proceso" className="py-24 md:py-32 bg-[#B8D4E8]/20">
