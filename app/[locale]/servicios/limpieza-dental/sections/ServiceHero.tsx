...
export function ServiceHero() {
  ...
  const whatsappText = locale === 'es'
    ? 'Hola, me gustaría agendar una cita para limpieza dental'
    : 'Hello, I would like to schedule an appointment for a dental cleaning'
    ...
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <Image
        ...
        alt={
          locale === 'es'
            ...
            : 'Professional dental cleaning by Dr. Alondra Robles in Guadalajara'
        }
        fill
        priority
        sizes="100vw"
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 md:pt-36 pb-24 md:pb-32">
        ...
        >
          ...
          >
            {t('title1')}{' '}
            <span className="text-[#B8D4E8]">{t('titleHighlight')}</span>{' '}
            {t('title2')}
          </motion.h1>
          ...
          >
            ...
            <a
              ...
              onClick={() => trackWhatsAppClick('service_hero_cleaning')}
