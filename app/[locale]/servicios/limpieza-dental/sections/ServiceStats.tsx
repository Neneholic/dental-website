...
import { Sparkles, ThumbsUp, Clock, Award } from 'lucide-react';
import { useTranslations } from 'next-intl';

const stats = [
  { icon: Sparkles, value: 500, suffix: '+' },
  { icon: ThumbsUp, value: 100, suffix: '%' },
  { icon: Clock, value: 1, suffix: '' },
  { icon: Award, value: 6, suffix: '+' },
];

export function ServiceStats() {
  const t = useTranslations('cleaning.stats');
  const labels = [t('cleanings'), t('satisfaction'), t('visits'), t('experience')];

  return (
    <section className="bg-[#B8D4E8]/30 py-12 md:py-16">
